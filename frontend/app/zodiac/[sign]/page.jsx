...
export default function ZodiacDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Zodiac Sign Not Found</h1>
  ...
  const luckyNumbers = Array.isArray(zodiac.luckyNumbers) ? zodiac.luckyNumbers : [];
  const luckyColors = Array.isArray(zodiac.luckyColors) ? zodiac.luckyColors : [];
        ...
        <section className="py-12 bg-gradient-to-br from-blue-50 to-purple-50 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <Link href="/">
              <Button 
                variant="outline" 
                className="mb-6 group hover:bg-white/80 backdrop-blur-sm border-gray-200"
              >
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              {/* Icon */}
              <Card className={`w-40 h-40 bg-gradient-to-br ${zodiac.color} rounded-full flex items-center justify-center shadow-2xl border-0 p-0 hover:scale-105 transition-transform duration-300`}>
                <span className="text-6xl text-white drop-shadow-lg">{zodiac.symbol}</span>
              </Card>
                ...
                <div className="flex flex-wrap gap-4 mt-6">
                  <Card className="px-4 py-2 bg-white/60 backdrop-blur-sm border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-gray-700">{zodiac.dates}</span>
                    </div>
                  </Card>
                  <Card className="px-4 py-2 bg-white/60 backdrop-blur-sm border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div className="flex items-center gap-2">
                  ...
                  <Card className="px-4 py-2 bg-white/60 backdrop-blur-sm border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-gray-700">{planet}</span>
                    </div>
                  </Card>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                {/* Overview Card */}
                <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-[1.01] border-l-4 border-l-orange-500">
                  <CardHeader className="flex flex-row items-center gap-3">
                    <div className={`p-2 rounded-lg bg-gradient-to-br ${zodiac.color} bg-opacity-20`}>
                ...
                <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-[1.01]">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-gray-900">Personality</CardTitle>
              ...
              <div className="space-y-6">
                    ...
                    <div className="relative w-full h-80 bg-gradient-to-br from-gray-100 to-gray-200">
                      {zodiac.image && zodiac.image !== '/placeholder.png' ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-gray-400">
                          <div className={`w-32 h-32 bg-gradient-to-br ${zodiac.color} rounded-full flex items-center justify-center mb-4 shadow-lg`}>
                            <span className="text-6xl text-white">{zodiac.symbol}</span>
                          </div>
                          <span className="text-sm font-medium">Zodiac Illustration</span>
                        </div>
                      )}
                    </div>
                  </CardContent>
                ...
                <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-[1.01]">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-gray-900">Lucky Numbers</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-[1.01]">
                  <CardHeader>
                    <CardTitle className="text-2xl font-bold text-gray-900">Lucky Colors</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-2 gap-3">
                      {luckyColors.map((color, index) => (
                        ...
                        >
                          <div className={`w-8 h-8 rounded-full ${getColorClass(color)} shadow-md flex-shrink-0`}></div>
