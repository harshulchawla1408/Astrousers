...
export default function AudioCall({ sessionId }) {
  ...
  }, [token, channelName, uid, appId, isConnected, loading]);
        ...
        <Card className="bg-white/10 backdrop-blur-sm border-0 shadow-xl">
          <CardContent className="p-6">
            <div className="text-center space-y-2">
              ...
              <div className="text-white/60 text-sm">Waiting for session to be accepted by astrologer...</div>
            </div>
          </CardContent>
        </Card>
      );
